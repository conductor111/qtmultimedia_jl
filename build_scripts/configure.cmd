...
rem Conductor: -prefix НЕ использовать!!! Потом проблем не оберешься!!!
configure -no-mp -debug-and-release -developer-build -platform win32-msvc2015 -opensource -force-debug-info -confirm-license -c++std c++11 -make libs -make tools -printing-and-pdf -no-openssl -gstreamer 1.0 -L%GSTREAMER_DIR%lib\ -L%GSTREAMER_DIR%bin\ -L%GSTREAMER_DIR%
SET CL=/MP1

rem configure -help
rem configure -platform win32-msvc2015 -list-features
