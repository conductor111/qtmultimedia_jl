...
GstElement *QGstreamerVideoEncode::createEncoder()
{
    ...
    GstElement *sinkCapsFilter = gst_element_factory_make("capsfilter", "capsfilter-video-sink");
    GstElement *srcCapsFilter = gst_element_factory_make("capsfilter", "capsfilter-video-src");
