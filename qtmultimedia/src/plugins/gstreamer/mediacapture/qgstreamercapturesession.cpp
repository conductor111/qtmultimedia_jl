...
void QGstreamerCaptureSession::setState(QGstreamerCaptureSession::State newState)
{
    ...
    if (newMode != m_pipelineMode) {
        ...
        if (m_pipelineMode == PreviewAndRecordingPipeline || m_pipelineMode == RecordingPipeline) {
        //////////////////////////////////////////////////////////////////////////
            if (!m_waitingForEos) {
...
// jl
class QGstreamerCaptureSessionWrapperImpl : public QGstreamerCaptureSessionWrapper
{
public:
    virtual QGstreamerRecorderControl *recorderControl() const
    {
        return m_session->recorderControl();
    }

    virtual QGstreamerMediaContainerControl *mediaContainerControl() const
    {
        return m_session->mediaContainerControl();
    }

    virtual QGstreamerAudioEncode *audioEncodeControl() const
    {
        return m_session->audioEncodeControl();
    }

    virtual QGstreamerVideoEncode *videoEncodeControl() const
    {
        return m_session->videoEncodeControl();
    }

    virtual void setVideoInput(QGstreamerVideoInput *videoInput)
    {
        m_session->setVideoInput(videoInput);
    }

    virtual void setState(QGstreamerCaptureSession::State state)
    {
        m_session->setState(state);
    }

    virtual QGstreamerCaptureSession::State state() const
    {
    ...
    QGstreamerCaptureSessionWrapperImpl(QGstreamerCaptureSession::CaptureMode captureMode, QObject *parent)
    {
        m_session = new QGstreamerCaptureSession(captureMode, parent);
    }
    virtual ~QGstreamerCaptureSessionWrapperImpl()
    {
        if (m_session)
        {
            delete m_session;
...
private:
    QGstreamerCaptureSession* m_session = nullptr;
};

QGstreamerCaptureSessionWrapper* createQGstreamerCaptureSessionWrapper(QGstreamerCaptureSession::CaptureMode captureMode, QObject *parent)
{
    return new QGstreamerCaptureSessionWrapperImpl(captureMode, parent);
}
/////////////////////////////////////////////////////////////////////
