...
# ifndef WIN_GST_API_EX
#  ifdef WIN_GST_EXPORT_EX
#    define WIN_GST_API_EX __declspec(dllexport)
#  else
#    define WIN_GST_API_EX __declspec(dllimport)
#  endif
# endif
...
// jl
class QGstreamerCaptureSessionWrapper
{
public:
    virtual QGstreamerRecorderControl *recorderControl() const = 0;
    virtual QGstreamerMediaContainerControl *mediaContainerControl() const = 0;
    virtual QGstreamerAudioEncode *audioEncodeControl() const = 0;
    virtual QGstreamerVideoEncode *videoEncodeControl() const = 0;

    virtual void setVideoInput(QGstreamerVideoInput *videoInput) = 0;
    virtual void setState(QGstreamerCaptureSession::State state) = 0;
    virtual QGstreamerCaptureSession::State state() const = 0;
    
    virtual void Release() = 0;
};

extern "C" WIN_GST_API_EX QGstreamerCaptureSessionWrapper* createQGstreamerCaptureSessionWrapper(QGstreamerCaptureSession::CaptureMode captureMode, QObject *parent);
/////////////////////////////////////////////////////////////////////
