...
// jl
#include "../mediacapture/qgstreamercapturesession.h"
///////
...
public:
    ...
    // jl
    // from QGstreamerElementFactory
    virtual GstElement *buildElement();
    virtual QList<qreal> supportedFrameRates(const QSize &frameSize = QSize()) const
    {
        Q_UNUSED(frameSize);

        return QList<qreal>();
    }
    virtual QList<QSize> supportedResolutions(qreal frameRate = -1) const
    {
        Q_UNUSED(frameRate);
    ...
    // jl
    static void configureAppSrcObjects(QNetworkRequest request, QGstAppSrc *appSrc, GstElement *gstappsrc, QIODevice** appSrcStream = nullptr);
    //////////////////////////////////////////////////////////////////////////
#endif
...
private:
    ...
    QGstAppSrc *m_appSrc;
    // jl
    QGstAppSrc *m_appSrcRecord = nullptr;
    //////////////////////////////////////////////////////////////////////////
#endif
