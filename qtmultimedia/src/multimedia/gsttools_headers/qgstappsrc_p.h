...
class WIN_GST_API QGstAppSrc  : public QObject
{
    Q_OBJECT
public:
    ...
    // jl
    bool& useCustomProcessing()
    {
        return m_useCustomProcessing;
    }
    bool& sendEosOnStreamEmptyData()
    {
        return m_sendEosOnStreamEmptyData;
    }
...
private:
    ...
    bool m_forceData;
    // jl
    bool m_useCustomProcessing = false;
    bool m_sendEosOnStreamEmptyData = true;
    GstClockTime m_timeStamp = 0;
    guint64 m_frameDuration = 0;
};
