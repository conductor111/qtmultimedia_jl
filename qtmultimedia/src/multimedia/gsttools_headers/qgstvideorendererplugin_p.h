...
class WIN_GST_API QGstVideoRenderer
{
public:
...
*/
class WIN_GST_API QGstVideoRendererInterface
{
public:
...
class WIN_GST_API QGstVideoRendererPlugin : public QObject, public QGstVideoRendererInterface
{
    Q_OBJECT
