...
class WIN_GST_API QGstDefaultVideoRenderer : public QGstVideoRenderer
{
public:
...
class WIN_GST_API QVideoSurfaceGstDelegate : public QObject
{
    Q_OBJECT
public:
...
class WIN_GST_API QGstVideoRendererSink
{
public:
    GstVideoSink parent;
...
class WIN_GST_API QGstVideoRendererSinkClass
{
public:
